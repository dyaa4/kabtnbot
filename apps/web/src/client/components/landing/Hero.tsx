  ...
  return (
    <section className="relative overflow-hidden px-6 pb-20 pt-12 md:pt-16">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        <div className="hero-aurora absolute -start-32 -top-40 h-[30rem] w-[30rem] rounded-full bg-blue-600/35 blur-3xl" />
        <div className="hero-aurora-slow absolute -end-24 -top-10 h-[26rem] w-[26rem] rounded-full bg-blue-500/25 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-8 md:grid-cols-[1fr_auto] md:gap-4">
        <div className="text-center md:text-start">
          <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-400/10 px-4 py-1.5 text-sm font-semibold text-blue-300">
          ...
          <div className="mb-5 flex flex-wrap justify-center gap-4 md:justify-start">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-xl bg-gradient-to-r from-blue-500 via-blue-500 to-blue-400 px-7 py-3.5 font-semibold text-slate-950 shadow-[0_0_30px_-6px_rgba(59,130,246,0.7)] transition hover:scale-105 hover:shadow-[0_0_40px_-4px_rgba(59,130,246,0.8)]"
            >
        ...
        <div className="relative mx-auto w-[300px] sm:w-[400px] md:w-[440px] lg:w-[520px]">
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            <div
              className="absolute bottom-[4%] left-1/2 h-[92%] w-[68%] -translate-x-1/2 bg-gradient-to-t from-blue-400/25 via-blue-500/10 to-transparent blur-2xl"
              style={{ clipPath: 'polygon(18% 100%, 82% 100%, 62% 0%, 38% 0%)' }}
            />
            <div className="absolute bottom-[-2%] left-1/2 h-[14%] w-[80%] -translate-x-1/2 rounded-[50%] bg-blue-400/25 blur-2xl" />
            <div className="absolute bottom-[-16%] left-1/2 aspect-square w-[105%] -translate-x-1/2">
              <div className="hero-ring h-full w-full border-2 border-blue-400/40 shadow-[0_0_24px_rgba(59,130,246,0.35)] [border-style:dashed]" />
            </div>
            <div className="absolute bottom-[-12%] left-1/2 aspect-square w-[82%] -translate-x-1/2">
              <div className="hero-ring-rev h-full w-full border border-blue-400/50 shadow-[0_0_18px_rgba(59,130,246,0.4)]" />
            </div>
            <span className="hero-particle absolute start-[8%] top-[30%] h-2 w-2 rounded-full bg-blue-300 shadow-[0_0_10px_rgba(59,130,246,0.9)]" />
            <span className="hero-particle absolute end-[6%] top-[46%] h-1.5 w-1.5 rounded-full bg-blue-300 shadow-[0_0_8px_rgba(129,140,248,0.9)] [animation-delay:-1.6s]" />
            <span className="hero-particle absolute end-[14%] top-[16%] h-2 w-2 rounded-full bg-blue-300 shadow-[0_0_10px_rgba(196,181,253,0.9)] [animation-delay:-2.2s]" />
          </div>

...
export const ar = {
  ...
  voicePremiumRequired: '💎 المساعد الصوتي حصري لسيرفرات البريميوم — رقِّ حسابك واربط هذا السيرفر من لوحة التحكم.',
  ...
  listenQuotaExhausted: '⏳ خلصت دقائق الاستماع الشهرية لهذا السيرفر. تتجدد مع بداية الشهر الجديد!',
  aiQuotaExhausted: '⏳ خلصت أسئلة الذكاء الاصطناعي الشهرية لهذا السيرفر.',
  ...
  settingsFieldQuotas: '⏳ الحصص الشهرية',
  settingsQuotasLine: 'استماع: {listen} دقيقة شهرياً • أسئلة AI: {ai} شهرياً',
  labelEnabled: 'مفعل',

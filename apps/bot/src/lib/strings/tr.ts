...
export const tr = {
  ...
  voicePremiumRequired: '💎 Sesli asistan premium sunuculara özeldir — hesabını yükselt ve bu sunucuyu panelden bağla.',
  ...
  listenQuotaExhausted: '⏳ Bu sunucunun aylık dinleme dakikaları bitti. Yeni ayın başında yenilenir!',
  aiQuotaExhausted: '⏳ Bu sunucunun aylık yapay zekâ soruları bitti.',
  ...
  settingsFieldQuotas: '⏳ Aylık kotalar',
  settingsQuotasLine: 'Dinleme: {listen} dk/ay • YZ soruları: {ai}/ay',
  labelEnabled: 'Etkin',
  ...
  reasonDomain: 'engellenen bağlantı',
  ...
  ticketAlreadyOpen: '⚠️ Zaten açık bir biletiniz var.',
  ticketNoCategory: '❌ Ayarlarda biletler için kategori belirlenmemiş.',
  ticketCreateFailed: '❌ Bilet oluşturulamadı.',
  ticketCreated: '✅ Biletiniz {channel} kanalında oluşturuldu.',
  ticketWelcomeDefault: 'Hoş geldin {mention}! 👋\nSorununu açıkla ve sana yardımcı olalım.',
  ticketCloseFailed: '❌ Bilet kapatılamadı.',
  ticketClosedDefault: 'Bilet kapatıldı. Desteğimizi kullandığınız için teşekkürler!',
  ticketLogClosed: '🔒 Bilet kapatıldı',
  ticketClaimDenied: '❌ Bu bileti üzerinize alma yetkiniz yok.',
  ticketClaimed: '👋 {user} bu bileti üzerine aldı.',
